<template>
    <div class="container">
        ...
        <div class="row">
            <div v-for="producto in productos_ofertas_limitado_a_cuatro" :key="producto.id" class="col-md-3 mb-4">
...
<script setup>
    ...
    const productos_ofertas_limitado_a_cuatro = computed(() => {
        return inicioContenedor.PRODUCTOSOFERTASLIMITADOACUATRO
    })
    
    onMounted(() => {
        inicioContenedor.getListarProductoOfertaLimitadoACuatro(
            {
