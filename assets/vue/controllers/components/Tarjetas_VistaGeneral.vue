      ...
      <div class="carousel-inner">
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4">
            <div class="col">
              <div class="card h-100 p-2">
                <img src="../img/Imagen_prueba.webp" class="card-img-top" alt="..." />
                <div class="card-body pt-4">
                  <div class="row g-2">
                    <div class="col-5">
                      <span class="fs-5 fw-normal">S/. 255.00</span>
                    </div>
                    <div class="col-7 d-flex align-items-center">
                      <span
                        class="text-decoration-line-through fw-normal text-body-secondary"
                        >S/. 250.00</span
                      >
                    </div>
                    <div class="col-3">
                      <span class="badge bg-dark text-wrap">Ahorras</span>
                    </div>
                    <div class="col-9">
                      <span class="fs-6 fw-normal text-start">S/. 50.00</span>
                    </div>
                    <div class="col-12">
                      <span
                        >Shark IQ Robot Self-Empty XL Vacuum with Self-Empty
                        Base, Home Mapping, RV1002AE, New...</span
                      >
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p><b>Envío gratis</b>, llega <b>en 3+ dias</b></p>
                    </div>
        ...
        <div class="carousel-item">
          <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="../img/Layout 1.png" class="card-img-top" alt="..." />
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">This is a short card.</p>
                </div>
